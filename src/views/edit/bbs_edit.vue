<template>
  <div style="margin-top: 7px;">
      <div class="layui-row layui-col-space15" style="margin-left: 17%;">
        ...
        <div class="layui-col-md8 content detail">
          ...
          <div class="fly-panel detail-box">
            ...
            <div class="detail-body photos" v-html="topicsItem.topicContent"> </div>
          </div>
              ...
              <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item layui-form-text">
                  <div class="layui-input-block">
                    <!--富文本框-->
                    <wang-editor v-bind:menus="menus" v-model="editorContent" @handleEditor="handleEditor"/>
                  </div>
                </div>
                <div class="layui-form-item">
                  <button class="layui-btn" style="margin-top: 13px;" v-on:click="appendTopicContent()">立即发布</button>
    ...
    <!--预览-->
    <div><preview-dialog v-bind:previewData="previewData" v-bind:dialogVisible="dialogVisible" @handleClose="handleClose" /></div>
...
export default {
  ...
  methods:{
    // 初始加载帖子详细信息
    getPosts() {
      let detail = sessionStorage.getItem("edit")
    ...
    // 追加内容
    appendTopicContent(){
      let appendContent = this.getAppendContent();
      if (appendContent == '') {
        layer.alert("请输入内容", {
          icon: 5,
          title:"提示"
      ...
      //组装后台数据
      let data ={token:getToken(), content:appendContent, id:this.topicsItem.id}
