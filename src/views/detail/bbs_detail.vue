<template>
  ...
  <div class="layui-container">
      ...
      <div class="layui-col-md8 content detail">
        <div class="fly-panel detail-box">
          ...
          <div class="fly-detail-info">
            ...
            <span class="fly-list-nums">
								<a v-on:click="handleReportPost(topicsItem)"><i class="layui-icon" title="举报">&#x1007;</i> 举报</a>
								<a v-on:click="handleBBS(2)"><i class="layui-icon" title="收藏">&#xe658;</i> {{ getNum(topicsItem.collectCount)}}</a>
								<a v-on:click="handleBBS(1)"><i class="layui-icon" title="点赞">&#xe6c6;</i> {{ getNum(topicsItem.praiseCount) }}</a>
        ...
        <div class="fly-panel detail-box" id="flyReply">
          ...
          <ul class="jieda" id="jieda">
            <li data-id="111" class="jieda-daan" v-for="(item, index) in replyDetailList" :key="index">
              ...
              <div class="jieda-reply">
                  <a href="#goto" v-on:click="handleReplyToReply(item)">
									<span type="reply">
                ...
                <div class="jieda-admin">
                  <span type="del" v-on:click="reportMsgClick(item)">举报</span>
                </div>
              </div>
            </li>
          ...
          <div class="layui-form layui-form-pane" id="goto" v-show="topicsItem.isOpenComment === 1">
              <div class="layui-form-item layui-form-text">
                <a name="comment"></a>
                <div class="layui-input-block">
                  <wang-editor ref="wangEditor" v-bind:menus="menus" :content="content" @handleEditor="handleEditor"/>
                </div>
              </div>
              <div class="layui-item">
                <button class="layui-btn" v-on:click="handleReply">提交回复</button>
              </div>
          </div>
        </div>
      </div>
    ...
    <div><report-msg-div v-bind:replyData="replyData" v-bind:replyTitle="replyTitle" v-bind:dialogVisible="dialogVisible" @handleClose="handleClose" @handleSubmit="handleSubmit"/></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getPosts() {
      ...
      if(!detail.type){
        let type = this.global.categoryItems[this.labelList.id]
        detail['type']= type
      }
