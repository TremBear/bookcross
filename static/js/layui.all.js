...
! function(e) {
	...
	n.prototype.cache = o, n.prototype.define = function(e, t) {
		...
		var s = (r || e).replace(/\.|\//g, ""),
			c = u.id = "layuicss-" + s,
			p = 0;
		return u.rel = "stylesheet", u.href = e + (o.debug ? "?vo=" + (new Date).getTime() : ""), u.media = "all", t.getElementById(c) || l.appendChild(u), "function" != typeof n ? a : (function y() {
	...
	var e = window.layui && layui.define,
		...
		n = {
			...
			ready: function(a) {
				var i = "laydate",
					r = "",
					o = (e ? "modules/laydate/" : "theme/") + "default/laydate.css?vo=" + n.v + r;
	...
	var i, n, a = e.layui && layui.define,
		...
		r = {
			...
			ready: function(e) {
				var t = "layer",
					i = "",
					n = (a ? "modules/layer/" : "theme/") + "default/layer.css?vo=" + r.v + i;
